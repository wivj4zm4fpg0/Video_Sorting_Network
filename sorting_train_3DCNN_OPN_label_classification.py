...
from models.cnn3d_OPN import cnn3d_OPN
...
parser.add_argument('--sort_frame_num', type=int, default=3, required=False)
...
sort_frame_num = args.sort_frame_num
...
# 初期設定
# resnet18を取得
Net = cnn3d_OPN(frame_num=sort_frame_num, pretrained=args.use_pretrained_model)
...
def train(inputs, labels):
    ...
    loss = criterion(outputs, labels)  # Loss値を計算 batch_first = False
