...
from CNN_LSTM_SORT_Model import CNNLSTMCombination
...
# 初期設定
# resnet18を取得
Net = CNNLSTMCombination(frame_num, pretrained=args.use_pretrained_model, bidirectional=args.use_bidirectional)
